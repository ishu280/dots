...
plugins=(colored-man-pages dotbare git fzf zsh-syntax-highlighting zsh-autosuggestions zsh-z zsh-history-substring-search)
...
PROMPT=$'%{\e[1;34m%} \{ %{\e[1;35m%}$ %{\e[1;34m%}\} %{\e[1;37m%}\ '
#PROMPT=$'%{\e[1;34m%}\┌─[%{\e[1;37m%}%t %D %{\e[1;34m%}]──%{\e[1;31m%}> %{\e[1;34m%}%n%{\e[1;37m%}@%{\e[1;34m%}%M: %{\e[0;37m%}$ \n%{\e[1;34m%}\└────%{\e[1;31m%}> '
RPROMPT=$'\$vcs_info_msg_0_ %{\e[1;35m%}\U007B%{\e[1;31m%} %~ %{\e[1;35m%}\U007D '
